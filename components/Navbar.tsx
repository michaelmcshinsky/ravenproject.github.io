...
export function Navbar() {
  ...
  return (
    <nav id="rvn--navbar" className="relative z-50 py-4 text-gray-500 bg-white border-b border-gray-200 dark:bg-gray-900 dark:text-gray-300">
      <div className="relative flex items-center justify-between h-16 px-4 mx-auto max-w-7xl md:px-0">
